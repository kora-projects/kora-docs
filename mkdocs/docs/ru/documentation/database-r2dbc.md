...
Общие правила для отображений, `@Repository`, `@Query`, `@Batch`, `UpdateCount`, макросов, ручных запросов и других
...
Основные параметры конфигурации R2DBC:
...
===! ":material-code-json: `HOCON`"
    ...
    1.  `R2DBC URL` подключения к базе данных (`обязательный`, по умолчанию не указано)
...
Можно переопределять преобразование разных частей [отображения](database-common.md), результата и параметров запроса.
