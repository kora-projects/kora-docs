...
Все это дает эффективность работы всей команды разработки
...
Также подход с созданием исходного кода позволяет проверять контейнер зависимостей на этапе компиляции
