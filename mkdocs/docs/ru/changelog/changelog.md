...
* Исправлено создание `OpenAPI` модели, где дискриминатор с `1` значением, был обязательным аргументом конструктора в Java
* Исправлено именование `OpenAPI` поля модели с типом `Enum` массив
