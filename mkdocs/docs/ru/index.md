...
Впоследствии совокупность таких простых кубиков, позволяет в итоге решать большие сложные задачи, 
но и не представляет сложности в понимании по если смотреть на них по отдельности,
не создавая излишнюю умственную нагрузку на разработчика.
