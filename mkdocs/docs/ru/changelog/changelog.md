...
* Исправлена обратная совместимость со старыми версиями представленной в `1.1.11` конфигурации телеметрии HTTP-клиента
* Исправлено обработка отсутствующих тегов в метриках нескольких модулей
* Исправлена проверка Jdbc Kotlin `ResultSet.next()` для опциональных параметров
* Исправлено включение логирования HTTP-клиента
