...
- Исправлено строгое сопоставление тегов перехватчиков в KSP
...
- Исправлен понижение Jackson до 2.19.4 из-за зависимостей Kotlin `2.x`+ через BOM
...
- Обновлена аннотация кэша: время хранения изменено с `class` на `runtime`
