...
* Добавлены обогащенные метрики HTTP-клиента и сервера
* Добавлены аннотации дополнительных контрактов методов для HTTP клиента/сервера в OpenAPI
* Добавлен дополнительная аннотация для создания преобразователей результатов [JDBC](../documentation/database-jdbc.md#_6)
...
* Исправлена поддержка фабрики компонентов IntersectType Java generics
* Исправлено исключение QuartzJob и неправильное протоколирование
* Исправлено сопоставление строк значений конфигурации для Enum типов
* Исправлено чтение типов Set и Map на реализации Linked коллекций для сохранения правильного порядка
* Исправлена поддержка нулевых попыток Retry
* Исправлено отображение строки HttpClientRequestMapper в качестве типа содержимого простого текста
