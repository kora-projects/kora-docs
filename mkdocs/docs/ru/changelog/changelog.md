...
* Исправлен операции множественного получения ключей для кэша `Redis`
...
* Исправлено разрешение пустых интерфейсов в качестве цели для `@ConfigValueExtractor` в Kotlin
