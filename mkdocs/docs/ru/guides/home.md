...
- [Конфигурация HOCON](config-hocon.md), [Конфигурация YAML](config-yaml.md), [JSON](json.md) и [Валидация](validation.md) - базовые возможности, которые обычно нужны каждому сервису.
...
- Эксплуатационные возможности: [Кеширование](cache.md), [Многоуровневое кеширование](cache-multi-level.md), [Отказоустойчивость](resilient.md) и [Наблюдаемость](observability.md).
