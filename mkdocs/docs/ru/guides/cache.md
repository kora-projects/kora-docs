...
После компиляции сгенерированный AOP-прокси показывает путь чтения через кэш:
...
После компиляции сгенерированный прокси показывает, что исходное обновление выполняется до записи в кэш:
...
вы можете посмотреть сгенерированный прокси здесь:
