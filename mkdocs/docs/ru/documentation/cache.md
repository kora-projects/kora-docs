...
===! ":material-code-json: `Hocon`"
    ...
    1.  Время по истечении которого значение для ключа будет удалено, отчитывается после добавления значения (по умолчанию отсутвует)
    2.  Время по истечении которого значение для ключа будет удалено, отчитывается после операции чтения (по умолчанию отсутвует)
    3.  Начальный размер кэша (помогает избежать расширения кэша в случае активного набухания) (по умолчанию отсутвует)
...
===! ":material-code-json: `Hocon`"
    ...
    2.  Имя пользователя для подключения (по умолчанию отсутвует)
    3.  Пароль пользователя для подключения (по умолчанию отсутвует)
    4.  Номер базы для подключения (по умолчанию отсутвует)
