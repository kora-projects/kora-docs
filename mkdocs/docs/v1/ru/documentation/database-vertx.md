...
Общие правила для отображений, `@Repository`, `@Query`, `@Batch`, `UpdateCount`, макросов и других механизмов
...
Основные параметры конфигурации Vert.x:
...
===! ":material-code-json: `HOCON`"
    ...
    1.  [URI](https://vertx.io/docs/vertx-pg-client/java/#_connection_uri) подключения к базе данных (`обязательный`, по умолчанию не указано)
    ...
    4.  Имя пула соединений (`обязательный`, по умолчанию не указано)
...
Общие правила отображений, `@Table`, `@Column`, `@Id`, `@Embedded`, `@Batch` и макросов описаны в разделе
...
Можно переопределять преобразование разных частей [отображения](database-common.md), результата запроса и параметров запроса.
...
Преобразователь колонки результата и преобразователь параметра можно сочетать на одном поле отображения.
