...
с точки зрения своего инструмента сборки `Gradle/итд.`, где
...
по средствам аннотации `@Tag`, которая принимает на вход класс тега. 
...
и тп поддерживают [штатное завершение](https://maxilect.ru/blog/pochemu-vazhen-graceful-shutdown-v-oblachnoy-srede-na-pr/) из коробки по средствам 
