...
=== ":fontawesome-brands-java: `Java`"
    ...
    dependencies {
        koraBom platform("ru.tinkoff.kora:kora-parent:1.0.4")
...
При этом в логах видно, что поднялся только порт `8085`.
Это происходит из-за того, что у нас ещё нет ни одного обработчика запросов.
