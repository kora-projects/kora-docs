...
* Добавлены дополнительные методы создаваемые OpenAPI, без необязательных параметров для HTTP Client со значениями по умолчанию
...
* Исправлена обработка фиксации событий при обработке в `@KafkaListener`
