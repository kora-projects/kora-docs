...
* Исправлен созданный `OpenAPI` конструктор модели, где дискриминатор с `1` значением, был обязательным аргументом конструктора в Java
* Исправлено именование созданной `OpenAPI` поля модели с типом `Enum` массив
