...
Модуль для создания отказоустойчивого приложения с использованием таких подходов как [прерыватель](#circuitbreaker),
[резервный метод](#fallback), [повторитель](#retry) и [ограничитель](#timeout) с помощью аннотаций аспектов в декларативном стиле.
