...
* Добавлен булевый тип в Config как родной тип

Исправлено:

* Исправлена обработка телеметрии клиента Grpc при отмене запроса
* Исправлено совместимость интерфейсов общих компонентов шаблона для обработчика графа
* Исправлено засыпание приватного HTTP-сервера при освобождении
* Исправлено описание у `ResourceConfigOrigin` в конфигурации для улучшения сообщения об ошибоках
