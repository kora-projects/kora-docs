...
- Исправлен счетчик ошибок `CircuitBreaker` в полуоткрытом состоянии, появившийся в [1.1.24](#1124)
...
- Исправлена OpenAPI генерация `Cookie` авторизации безопасности для HTTP-сервера в Kotlin
