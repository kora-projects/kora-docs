...
- Обновлены и синхронизированы зависимости для всех модулей
- Добавлено улучшенное сообщение о сборке компонента
- Стандартизированы сообщения компонент жизненного цикла
- Добавлена поддержка метрик Opentelemetry нового стандарта 1.23
- Добавлена поддержка виртуальных потоков GraalVM и GraalVM для большинства модулей

Исправлено:

- Исправлено ненужное обновление узлов графа приложений
- Исправлено отсутствие аннотаций `@Generated`
- Исправлено исключение записи в закрытое соединение Undertow не должно игнорировать телеметрию
- Исправлены незначительные проблемы с Resilient
- Исправлено `HttpBody.contentLength` должен быть длинным
- Исправлено падение процессора аннотаций AOP без зависимостей kora в блоке компиляции
- Исправлено поведение `@ResponseCodeMapper`, когда определен только код
- Исправлена метрика микрометра драйвера Cassandra
